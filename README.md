...
- | Windows Enumeration | Windows Privilege Escalation | Active Directory Fundamentals |
- | Vulnerability Validation | Exploit Research | Post Exploitation |
- | Linux Privilege Escalation | Linux Enumeration |

### Security Tooling

- | Python Security Automation | Reconnaissance Frameworks | Enumeration Utilities | Custom Security Scripts | Security Research |

### Documentation

- | Professional Assessment Reports | Technical Writeups | Walkthrough Documentation | Security Research Notes |
